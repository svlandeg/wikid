...
def main(
    ...
    entity_limit (Optional[int]): Max. number of entities to parse from Wikidata. Unlimited if None.
    article_limit (Optional[int]): Max. number of articles to parse from Wikipedia. Unlimited if None.
    alias_limit (Optional[int]): Max. number of WP articles to parse for entity aliases. Unlimited if None.
    """

    parse(
        language=language,
        use_filtered_dumps=use_filtered_dumps,
        preprocess_for_qtdm=preprocess_for_qtdm,
